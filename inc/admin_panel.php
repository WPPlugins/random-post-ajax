...
function rndpst_my_rndpst_submenu_page_callback(){
	...
	<form method="post" action="options.php">
		...
		<div class="mother-of-base">
					...
					<div id="tab4" class="tab">
						...
						<div class="about-us">
							<div class="description">
								...
								<b><?php echo __('Authors','random-post-ajax'); ?>: </b> <a href="http://misaco.ir">MiSaCo. </a> <br>
			...
			<div class="copyright">
				<?php echo __('Created With','random-post-ajax'); ?> <span class="love"> &#10084; </span> <?php echo __('By','random-post-ajax'); ?> <a href="http://misaco.ir">MiSaCo. </a>
			</div>
